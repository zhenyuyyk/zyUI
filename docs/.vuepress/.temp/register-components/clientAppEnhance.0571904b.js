    ...
    export default ({ app }) => {    
      ...
      app.component("form-formContentWidth", defineAsyncComponent(() => import("D:/myProject/zyAdmin/docs/examples/form/formContentWidth.vue"))),
      ...
      app.component("form-formRuleZiding", defineAsyncComponent(() => import("D:/myProject/zyAdmin/docs/examples/form/formRuleZiding.vue"))),
